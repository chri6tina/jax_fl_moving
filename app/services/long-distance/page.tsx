...
export const metadata: Metadata = {
  title: 'Long Distance Movers | Jacksonville to Anywhere',
  description:
    'Reliable long distance movers from Jacksonville with clear timelines, careful packing, and transparent pricing. Licensed & insured crews.',
  alternates: { canonical: '/services/long-distance' },
  openGraph: {
    title: 'Long Distance Movers | Jacksonville to Anywhere',
    description:
      'Reliable long distance movers from Jacksonville with clear timelines and transparent pricing.',
    type: 'article',
    locale: 'en_US',
  },
};
    ...
    <>
      <Section className="pt-8 sm:pt-10 lg:pt-12">
        <nav aria-label="Breadcrumb" className="text-sm text-slate-600">
          <ol className="flex flex-wrap items-center gap-2">
            ...
            <li className="font-medium text-slate-900">Long Distance</li>
          </ol>
        </nav>
          ...
          <div className="relative grid items-start gap-8 p-4 sm:p-6 lg:p-10 lg:grid-cols-[1.15fr_.85fr]">
            <header className="max-w-2xl rounded-2xl bg-white/95 p-6 shadow-md ring-1 ring-slate-200 backdrop-blur-sm sm:p-8">
              <div className="inline-flex items-center gap-2 rounded-full bg-teal-50 px-3 py-1 text-xs font-medium text-teal-700 ring-1 ring-inset ring-teal-200">
                Jacksonville → Statewide & Beyond
              </div>
              <h1 className="mt-4 text-4xl font-semibold tracking-tight text-slate-900 sm:text-5xl">
                Long distance movers you can count on
              </h1>
              <p className="mt-4 text-lg text-slate-700">
                Clear timelines, careful packing, and consistent communication from pickup to delivery.
              ...
              <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                <Link className="w-full sm:w-auto" href="#quote">
                  <Button className="w-full bg-teal-600 hover:bg-teal-700">Get my long distance quote</Button>
                </Link>
                <a
      ...
      <Section>
        <div className="mx-auto max-w-5xl">
          <h2 className="text-2xl font-semibold text-slate-900">Long-distance ballpark</h2>
          <p className="mt-2 text-slate-700">
            This rough estimator blends crew time with a per‑mile placeholder. We’ll finalize after a short walkthrough.
          </p>
          <div className="mt-4">
            <CostEstimator service="long-distance" />
          </div>
        </div>
      </Section>
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          <div>
            ...
            <ul className="mt-3 grid gap-2 text-slate-700 sm:grid-cols-2">
              <li>Dedicated crew</li>
              <li>Furniture padding & shrink wrap</li>
              <li>Itemized inventory on request</li>
              <li>Basic assembly / disassembly</li>
            </ul>
          </div>
          <div>
            <h2 className="text-2xl font-semibold text-slate-900">Pricing 101</h2>
            <p className="mt-2 text-slate-700">
              Your estimate considers inventory size, mileage, access (stairs/elevator), and packing.
              We’ll walk you through everything before we start—no hidden fees.
            </p>
          </div>
        </div>
      </Section>
